...
> linux的终端模拟包有： xterm, gnome, kconsole

shell命令提示符
---
不同linux发行版的命令提示符不同，默认格式为
```bash
...
```
while循环可用于读取键盘输入，按<Ctrl-D>结束循环
```bash
...
>>>>>>> c4ed88e77a3d730f3cbd20a4e72a0534a5762ece
